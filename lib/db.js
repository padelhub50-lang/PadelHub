...
export function createProduct(data) {
  ...
  d.prepare(
    `INSERT INTO products (id, name, category, price, old_price, description, images, stock, tag, active, position, stats, created_at, updated_at)
     VALUES (@id, @name, @category, @price, @old_price, @description, @images, @stock, @tag, @active, @position, @stats, @created_at, @updated_at)`
  ).run({
    id: productId,
...
export function updateProduct(productId, data) {
  ...
  d.prepare(
    `UPDATE products SET name=@name, category=@category, price=@price, old_price=@old_price,
