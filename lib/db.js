...
export function createProduct(data) {
  ...
  d.prepare(
    `INSERT INTO products (id, name, category, price, old_price, description, images, stock, tag, active, position, created_at, updated_at)
     VALUES (@id, @name, @category, @price, @old_price, @description, @images, @stock, @tag, @active, @position, @created_at, @updated_at)`
  ).run({
    id: productId,
