...
const CATALOG = [
  { name: "Bullpadel Vertex 04", category: "Ракетки", brand: "Bullpadel", price: 8990, oldPrice: 10490, tag: "Хіт", stock: 7, description: "Ракетка топового рівня, форма — сльоза. Контроль + потужність для агресивної гри.", stats: { attack: 9, defense: 5, control: 7, versatility: 5 } },
  { name: "Head Delta Pro", category: "Ракетки", brand: "Head", price: 7490, tag: "Новинка", stock: 12, description: "Кругла форма для максимального контролю. Легка й маневрена.", stats: { attack: 4, defense: 8, control: 8, versatility: 7 } },
  { name: "Babolat Technical Viper", category: "Ракетки", brand: "Babolat", price: 6290, oldPrice: 7290, tag: "Знижка", stock: 5, description: "Універсальна ракетка для гравців середнього рівня.", stats: { attack: 6, defense: 6, control: 6, versatility: 9 } },
