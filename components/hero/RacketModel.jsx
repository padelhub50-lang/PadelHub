...
// the racket's protective bumper rather than a flat painted stripe.
function buildFaceShape() {
  return buildHeadShape(0.9);
}
...
function makeFaceTexture() {
  ...
  grad.addColorStop(0.55, "#232326");
  grad.addColorStop(1, "#0d0d0f");
  ctx.fillStyle = grad;
  ctx.fillRect(0, 0, size, size);

  // Faint diagonal carbon-weave sheen instead of a flat matte fill.
