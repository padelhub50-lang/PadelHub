...
export default function RacketScene() {
  ...
  return (
    ...
    >
      ...
      <directionalLight position={[3, 4, 5]} intensity={1.3} color="#FFB84D" castShadow />
      <directionalLight position={[-4, -2, -3]} intensity={0.6} color="#5B7FFF" />
      <pointLight position={[0, -2, 3]} intensity={0.4} color="#FF5A1F" />
